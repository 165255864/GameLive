...
//搜索
+(id)search:(NSString*)keywords page:(NSInteger)page completionHandler:(void(^)(SearchModel* model,NSError* error))completionHandler;
...
//直播详情页
+ (id)getDetailsWithPage:(NSInteger)page  completionHandler:(void(^)(DetailsModel* model,NSError* error))completionHandler;
