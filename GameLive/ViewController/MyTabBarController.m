...
@property (nonatomic) MyController *mineVC;
...
//    tintColor:会影响到所有子视图的高亮颜色
    [UITabBar appearance].tintColor = [UIColor colorWithRed:252/255.0 green:50/255.0 blue:41/255.0 alpha:0.6];
...
- (MyController *)mineVC {
	if(_mineVC == nil) {
		_mineVC = [[MyController alloc]initWithStyle:UITableViewStyleGrouped];
        _mineVC.title = @"我的";
